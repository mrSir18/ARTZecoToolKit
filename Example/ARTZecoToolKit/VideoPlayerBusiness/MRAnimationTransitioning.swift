//
//  MRAnimationTransitioning.swift
//  ARTZecoToolKit
//
...
/// 动画过渡类型
extension MRAnimationTransitioning {
...
/// 动画过渡处理类
open class MRAnimationTransitioning: NSObject {
    ...
    public init(_ videoWrapperView: MRVideoPlayerWrapperView) {
...
extension MRAnimationTransitioning: UIViewControllerAnimatedTransitioning {
    ...
    open func animateTransition(using transitionContext: UIViewControllerContextTransitioning) {
        ...
        if transitionType == .presentation {
            guard let destinationView = transitionContext.view(forKey: .to),
                  let destinationController = transitionContext.viewController(forKey: .to) as? MRFullScreenController else { return }
