...
///
/// - NOTE: 可继承该协议方法
@objc protocol ARTVideoPlayerPortraitFullscreenBottombarDelegate: ARTVideoPlayerBottombarDelegate {
...
extension ARTVideoPlayerPortraitFullscreenBottombar {
    ...
    /// 点击退出清屏按钮
    @objc private func didTapExitClearButton() {
        DispatchQueue.main.async {
            UIView.animate(withDuration: 0.25) {
...
extension ARTVideoPlayerPortraitFullscreenBottombar {
    ...
    @objc private func setupToolBarView() { // 创建工具栏视图
        toolBarView = UIView()
    ...
    @objc private func setupGradient() { // 创建渐变色
    ...
    @objc private func setupTitleLabel() { // 创建标题标签
        titleLabel = UILabel()
    ...
    @objc private func setupDescLabel() { // 创建描述
        descLabel = UILabel()
    ...
    @objc private func setupFavoriteButton() { // 创建收藏按钮
    ...
    @objc private func setupCommentButton() { // 创建评论按钮
    ...
    @objc private func setupShareButton() { // 创建分享按钮
    ...
    @objc private func setupMoreButton() { // 创建更多按钮
    ...
    @objc private func setupClearButton() { // 创建清屏按钮
    ...
    @objc private func setupExitClearButton() { // 创建退出清屏按钮
    ...
    @objc private func setupAnimation() { // 过度动画流畅
